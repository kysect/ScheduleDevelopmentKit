...
using ScheduleDevelopmentKit.ConsolePolygon.ScheduleItemProviders;

namespace ScheduleDevelopmentKit.ConsolePolygon.Printers
{
    ...
    public static class PrinterExtensions
    {
        ...
        {
            printer.Print(provider.GetItems().Where(e => e.IsLecture()));
        }
